...
public class Pong extends JPanel implements KeyListener {
	...
	private final int SLOWER_DIAM=20;
	private final int SLOWER_SPEED=5;
	
	private int paddle_speed1 = 3,paddle_speed2=3;
	private int x= WIDTH/2, y= HEIGHT/2, speedX= 2, speedY = 3;
	private int paddle1 = WIDTH/2-PADDLE_WIDTH/2, paddle2= WIDTH/2-PADDLE_WIDTH/2;
	private int score1, score2;
	private int slower_count1=1, slower_count2=1;
	private int slower_position1=0, slower_position2=WIDTH-SLOWER_DIAM;
	private int slower_positionx2=paddle2+PADDLE_HEIGHT/2-SLOWER_DIAM/2;
	private int slower_positionx1=paddle1+PADDLE_HEIGHT/2-SLOWER_DIAM/2;
	...
	private boolean slower1=false, slower2=false, display1=true;
	...
	public void paint(Graphics g) {
		...
		if (solo2==true) {
			...
			int size= fontMetrics.stringWidth(sentance);
			g.drawString(sentance, WIDTH-size/8,20);
			
		if (display==false) {
			String sentance1= "No more balls left";
			int size1= fontMetrics.stringWidth(sentance1);
			g.drawString(sentance1, WIDTH-size1/8,40);
		}
	...
	public void restart() {
	    slower_positionx1= paddle1+PADDLE_HEIGHT/2-SLOWER_DIAM/2;
		slower_positionx2= paddle2+PADDLE_HEIGHT/2-SLOWER_DIAM/2;
		score1=0;
		score2=0;
		speedX=0;
		speedY=0;
