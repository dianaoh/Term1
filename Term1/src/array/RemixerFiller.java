...
public class RemixerFiller {
	...
	private String fileName = "WhiteChristmas.txt";	// this should match your txt file
	
	private String[] wordsToReplace= {"snow","white","merry","bright","glisten"};	// for part 2, if you finish the main project
	private String[] newWords= {"ash","dark","gloomy","pale","lifeless"};
